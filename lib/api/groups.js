...
class Groups {
    ...
    info (roomId, roomName, callback) {
        ...
        return this.client.request("GET", "groups.info", query, callback);
    }
    ...
    listAll ({ offset = 0, count = 0, sort = undefined, fields = undefined, query = undefined} ={}, callback) {
        return this.client.request("GET", "groups.listAll", pageQueryMapping(arguments[0]), callback);
    }
    ...
    setCustomFields(roomId, customFields, callback) {
        return this.client.request("POST", "groups.setCustomFields", {roomId, customFields}, callback);
    }

    setAnnouncement(roomId, announcement, callback) {
        return this.client.request("POST", "groups.setAnnouncement", {roomId, announcement}, callback);
    }
